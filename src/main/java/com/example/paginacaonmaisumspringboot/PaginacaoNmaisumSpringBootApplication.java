package com.example.paginacaonmaisumspringboot;
...
import com.example.paginacaonmaisumspringboot.repositories.CategoryRepository;
...
public class PaginacaoNmaisumSpringBootApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(PaginacaoNmaisumSpringBootApplication.class, args);
	}
